...
extensions = [
    ...
    Extension("ttygif.gif.application_extension"        ,[prefix+"./ttygif/gif/application_extension"      +ext2], define_macros=[('CYTHON_TRACE', '1')]),
    ...
    Extension("ttygif.gif.graphics_control_extension"   ,[prefix+"./ttygif/gif/graphics_control_extension" +ext2], define_macros=[('CYTHON_TRACE', '1')]),
