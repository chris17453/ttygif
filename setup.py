...
extensions = [
    ...
    Extension("ttygif.gif.ImageData"                    ,[prefix+"./ttygif/gif/ImageData"                  +ext ], define_macros=[('CYTHON_TRACE', '1')]),
    ...
    Extension("ttygif.gif.stream"                       ,[prefix+"./ttygif/gif/stream"                     +ext ], define_macros=[('CYTHON_TRACE', '1')]),
    Extension("ttygif.gif.trailer"                      ,[prefix+"./ttygif/gif/trailer"                    +ext ], define_macros=[('CYTHON_TRACE', '1')]),
    Extension("ttygif.tty.viewer"                       ,[prefix+"./ttygif/tty/viewer"                     +ext ], define_macros=[('CYTHON_TRACE', '1')]),
