...
cdef class DataStream:
    ...
    def write_bytes(self,byte_data):
        ...
        for byte in byte_data:
            ba.append(byte)
            self.pos+=1
        self.file_object.write(byte_data)
    ...
    def file_2_compressed_array(self,input_file,output_file):
...
#   ╚██████╗██║  ██║██║  ██║██║███████║ ██║   ██║       ██║███████║██████╔╝   *
#    ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚══════╝ ╚═╝   ╚═╝       ╚═╝╚══════╝╚═════╝    *
#  Auto generated by chris17453 bin2arr                                       *
# *****************************************************************************
...
""".format(input_name))
            for i in range(0,len(fileContent)):
                ...
                file_w.write_string("{0:02X}".format)
                if i>0:
                    file_w.write_string(",".format)
                    if i%50==0:
                        file_w.write_string("\n    ".format)
