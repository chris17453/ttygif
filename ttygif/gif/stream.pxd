...
cdef class DataStream:
    ...
    cdef read(self,length,word=None,char=None,byte=None,string=None)
    cdef write_byte(self,byte)
    cdef write_word(self,word)
    cdef write_string(self,string,length)
    cdef char(self,length,ptr=None,value=None)
    cdef byte(self,length,ptr=None,value=None,eod=None)
    cdef string(self,length,ptr=None,value=None,EOD=None)
    cdef word(self,length,ptr=None,value=None,EOD=None)
