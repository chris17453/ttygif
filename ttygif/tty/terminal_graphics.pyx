...
cdef class terminal_graphics:
    ...
    def __cinit__(self,int character_width=-1,int character_height=-1,theme_name=None,
        ...
        self.theme.auto(px_width,px_height)
...
#
    ...
    cdef render(self):
        ...
        if self.theme.layer1:
            self.theme.layer1.image.copy_9slice(self.viewport,self.theme.layer1.inner,self.theme.layer1.outer,self.viewport.get_rect())
        else:
