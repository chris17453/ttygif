...
def cli_main():
    ...
    parser.add_argument('--time-rate', help='process events af a faster or slower rate of time', default=1,metavar='DILATION', type=float)
    parser.add_argument('--fps',       help='encode at (n) frames per second (0-25) 0=speed of cast file, min 1ms', default=0,metavar='FPS', type=int)
