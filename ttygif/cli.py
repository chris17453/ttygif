...
def main():
    print("ttygif version {0}. Compiled against Python: {1} ".format( __version__,sys.version))
    ...
    parser.add_argument('--theme',     help='load custom theme/colors',default='default')
