...
def main():
    ...
    parser.add_argument('--record', '-r',   help='output generated cast data to file', metavar='FILE')
    parser.add_argument('--font',   '-f',   help='which internal font to use', metavar='NAME')
    
    parser.add_argument('--theme',  '-t',   help='load custom theme: game,windows7,mac,fwdm',default='default')
    ...
    parser.add_argument('--width',   '-w',  help='change character width of gif, default is 80 or what is in the cast file',metavar='WIDTH', type=int)
    parser.add_argument('--height',  '-h',  help='change character height of gif, default is 25 or what is in the cast file',metavar='HEIGHT', type=int)
