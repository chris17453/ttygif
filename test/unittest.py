...
class test_engine(unittest2.TestCase):
    ...
    def test_canvas_noninterlaced(self):
        try:
            ...
            g.canvas_it(base_dir+"/VGA_8x19font.gif",base_decode_dir+"/VGA_8x19font.html")
    ...
    def test_canvas_interlaced(self):
        try:
            ...
            g.canvas_it(base_dir+"/89a_interlaced.gif",base_decode_dir+"/89a_interlaced.html")
        except Exception as ex:
            self.fail(ex)
    ...
    def test_canvas_kermit(self):
        try:
            g=ttygif.gif(debug=None)
            g.canvas_it(base_dir+"/kermit.gif",base_decode_dir+"/kermit.html")
        except Exception as ex:
            self.fail(ex)
    ...
    def test_canvas_giphy(self):
        try:
            g=ttygif.gif(debug=None)
            g.canvas_it(base_dir+"/giphy.gif",base_decode_dir+"/giphy.html")
        except Exception as ex:
            self.fail(ex)
    ...
    def test_canvas_blue(self):
        try:
            g=ttygif.gif(debug=None)
            g.canvas_it(base_dir+"/blue.gif",base_decode_dir+"/blue.html")
        except Exception as ex:
            self.fail(ex)
